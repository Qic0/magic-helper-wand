  ...
  useEffect(() => {
    ...
    const channel = supabase
      ...
      .on(
        ...
        () => {
          queryClient.invalidateQueries({ queryKey: ['worker-tasks', user.id] });
        }
      )
      .subscribe();
    ...
    <div className="min-h-screen bg-background pt-14">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <Select value={sortBy} onValueChange={(value: any) => setSortBy(value)}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="salary">По оплате</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div className="ml-auto">
                <Badge variant="outline" className="text-sm">
                  Найдено: {filteredAndSortedTasks.length}
                </Badge>
              </div>
            </div>
      ...
      {selectedTask && (
        <TaskCompletionDialog
          ...
          onComplete={() => {
            queryClient.invalidateQueries({ queryKey: ['worker-tasks', user?.id] });
            queryClient.invalidateQueries({ queryKey: ['worker-user-data', user?.id] });
